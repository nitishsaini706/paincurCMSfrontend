...
import { uploadImage, getBlogBySlug, updateBlog } from '../Utils/api';
...
const EditBlog = () => {
    ...
    useEffect(() => {
        const fetchBlogData = async () => {
            try {
                const response = await getBlogBySlug(slug); // Fetch blog by slug
                ...
                <div className="w-full p-4">
                    ...
                    <Form onSubmit={handleSubmit} >
                        <Form.Group controlId="formSport ">
                            ...
                            <Form.Control className='w-[150px]' as="select" name="services" value={formData.services} onChange={handleChange} isInvalid={!!formErrors.services}>
