    ...
    <div className="p-3 mx-[10px] w-64 h-screen  border-2">
      <div className='pt-2'>
        <div className={`${linkClass('/dashboard')} flex items-center mb-4`}>
          <CiGrid31 size="21"/>
          <Link to='/blogs' className={`${linktext('/dashboard')} no-underline ml-2`}>Dashboard</Link>
        </div>
        ...
        <div className={`${linkClass('/add-pain-program')} flex items-center mb-4`}>
          <CiYoutube size="21"/>
          <Link to='/create-pain-program' className={`${linktext('/add-pain-program')} no-underline ml-2`}>Create Pain Program</Link>
        </div>
        <div className={`${linkClass('/pains')} flex items-center mb-4`}>
          <CiViewTimeline size="21"/>
          <Link to='/list-pain-programs' className={`${linktext('/pains')} no-underline ml-2`}>List Pain Programs</Link>
        </div>
        <div className={`${linkClass('/patients')} flex items-center mb-4`}>
          <CiHospital1 size="21"/>
          <Link to='/patients' className={`${linktext('/patients')} no-underline ml-2`}>Patients</Link>
        </div>
        <div className={`${linkClass('/appointments')} flex items-center mb-4`}>
          <CiCalendarDate size="21"/>
          <Link to='/appointments' className={`${linktext('/appointments')} no-underline ml-2`}>Appointments</Link>
        </div>
        <div className={`${linkClass('/settings')} flex items-center mb-4`}>
          <CiSettings size="21"/>
          <Link to='/settings' className={`${linktext('/settings')} no-underline ml-2`}>Settings</Link>
        </div>
      </div>
    </div>
  );
